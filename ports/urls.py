...
import views
from ports.port.views import SearchAPIView
from ports.port.forms import AdvancedSearchForm
from ports.port.urls import router as port_router
from ports.category.urls import router as category_router
from ports.buildhistory.urls import router as buildhistory_router
from ports.maintainer.urls import router as maintainer_router
from ports.variant.urls import router as variants_router
from ports.stats.views import PortStatisticsAPIView, PortMonthlyInstallationsAPIView, GeneralStatisticsAPIView
from ports.user.views import FollowedPortsAPIView
